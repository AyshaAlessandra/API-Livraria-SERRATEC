...
public class CadastroEmpresaReceitaDTO {
	...
	public String toString() {
		return "CadastroEmpresaDTO [situacao=" + situacao + ", tipo=" + tipo + ", nome=" + nome + ", porte=" + porte
				+ ", abertura=" + abertura + ", data_situacao=" + data_situacao + ", motivo_situacao=" + motivo_situacao
				+ ", telefone=" + telefone + ", email=" + email + ", natureza_juridica=" + natureza_juridica + ", cnpj="
				+ cnpj + ", ultima_atualizacao=" + ultima_atualizacao + ", status=" + status + ", fantasia=" + fantasia
