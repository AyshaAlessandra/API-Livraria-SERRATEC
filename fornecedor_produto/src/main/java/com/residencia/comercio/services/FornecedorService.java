...
public class FornecedorService {
	...
	public CnpjDTO consultarDadosPorCnpj(String cnpj) {
		...
		CnpjDTO infoEmpresaCnpjDTO = restTemplate.getForObject(uri, CnpjDTO.class, params);

		return infoEmpresaCnpjDTO;
	}
	...
	public CepDTO consultarDadosPorCep(String cep) {
		...
		CepDTO consultaPorCep = restTemplate.getForObject(url, CepDTO.class, params);
	...
	public Fornecedor CnpjDTOtoFornecedor(CnpjDTO cnpjDTO) {
		...
		fornecedor.setCep(cnpjDTO.getCnpj());
